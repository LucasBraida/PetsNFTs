...
async function main() {
 try {
  ...
  console.log(avt)
  mintTxn = await petsNFTContract.connect(randomPerson2).mintNFT()
  mintTxn.wait();
  avt = await petsNFTContract.getAvailableNFTs()
  ...
  let ownerToken = await petsNFTContract.getOwnersTokens(randomPerson.address);
  console.log('RandomPerson ', ownerToken)
  ownerToken = await petsNFTContract.getOwnersTokens(randomPerson2.address);
  console.log('RandomPerson2 ', ownerToken)
  console.log('====================')
  let trasnfer = await petsNFTContract.connect(randomPerson2)["transferFrom(address,address,uint256)"](randomPerson2.address, randomPerson.address, 1);
  ownerToken = await petsNFTContract.getOwnersTokens(randomPerson.address);
  console.log('RandomPerson ', ownerToken)
  ownerToken = await petsNFTContract.getOwnersTokens(randomPerson2.address);
  console.log('RandomPerson2 ', ownerToken)
  console.log('====================')
